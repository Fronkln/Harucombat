...
typedef void* (__fastcall* t_fighter_mode_BattleStart_Constructor)(void* fmode, void* fighter);
typedef void* (__fastcall* t_fighter_mode_PlayerDeath_SetGMT)(void* fmode);
...
t_fighter_mode_BattleStart_Constructor hook_original_BattleStartConstructor;
